...
**Internet Frustration Barometer** — Discover what people are complaining about, asking for, and struggling with on Reddit, Hacker News, GitHub Issues & Dev.to.
...
- 🔍 **Real-time analysis** of Reddit, Hacker News, GitHub Issues & Dev.to
...
│   ├── sources/                 # Reddit, HN, GitHub & Dev.to clients
